...
@dataclass
class AgentWorkflowDecoratorV2State:
    entries: Dict[str, dict] = field(default_factory=dict)
    _seq: int = 0
    callbacks: Dict[str, Callable] = field(default_factory=dict)

class AgentWorkflowDecoratorV2:
    PREFIX = "awdv-"
    MAX_ENTRIES = 10000

    def __init__(self) -> None:
        self._state = AgentWorkflowDecoratorV2State()
    ...
    def decorate_v2(self, agent_id: str, workflow_name: str, style: str = "default", metadata: Optional[dict] = None) -> str:
        ...
        self._prune()
        self._fire("decorate_v2", agent_id=agent_id, record_id=record_id)
        return record_id
    ...
    def get_stats(self) -> dict:
        ...
        return {"total_decorations": len(entries), "unique_agents": len(agents)}
