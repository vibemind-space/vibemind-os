...
@dataclass
class AgentTaskReviewerV2State:
    entries: Dict[str, dict] = field(default_factory=dict)
    _seq: int = 0
    callbacks: Dict[str, Callable] = field(default_factory=dict)

class AgentTaskReviewerV2:
    PREFIX = "atrvv-"
    MAX_ENTRIES = 10000

    def __init__(self) -> None:
        self._state = AgentTaskReviewerV2State()
    ...
    def review_v2(self, task_id: str, agent_id: str, depth: str = "standard", metadata: Optional[dict] = None) -> str:
        ...
        self._prune()
        self._fire("review_v2", task_id=task_id, record_id=record_id)
        return record_id
    ...
    def get_stats(self) -> dict:
        ...
        return {"total_reviews": len(entries), "unique_agents": len(unique)}
