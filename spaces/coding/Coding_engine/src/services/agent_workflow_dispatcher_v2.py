...
@dataclass
class AgentWorkflowDispatcherV2State:
    entries: Dict[str, dict] = field(default_factory=dict)
    _seq: int = 0
    callbacks: Dict[str, Callable] = field(default_factory=dict)

class AgentWorkflowDispatcherV2:
    PREFIX = "awdp-"
    MAX_ENTRIES = 10000

    def __init__(self) -> None:
        self._state = AgentWorkflowDispatcherV2State()
    ...
    def dispatch_v2(self, agent_id: str, workflow_name: str, target: str = "default", metadata: Optional[dict] = None) -> str:
        ...
        self._prune()
        self._fire("dispatch_v2", agent_id=agent_id, record_id=record_id)
        return record_id
    ...
    def get_dispatches(self, agent_id: str = "", limit: int = 50) -> List[dict]:
    ...
    def get_stats(self) -> dict:
        ...
        return {"total_dispatches": len(entries), "unique_agents": len(unique)}
