...
@dataclass
class PipelineDataMigratorV2State:
    entries: Dict[str, dict] = field(default_factory=dict)
    _seq: int = 0
    callbacks: Dict[str, Callable] = field(default_factory=dict)

class PipelineDataMigratorV2:
    PREFIX = "pdmv-"
    MAX_ENTRIES = 10000

    def __init__(self) -> None:
        self._state = PipelineDataMigratorV2State()
    ...
    def migrate_v2(self, pipeline_id: str, data_key: str, target: str = "default", metadata: Optional[dict] = None) -> str:
        ...
        self._prune()
        self._fire("migrate_v2", pipeline_id=pipeline_id, record_id=record_id)
        return record_id
    ...
    def get_stats(self) -> dict:
        ...
        return {"total_migrations": len(entries), "unique_pipelines": len(pipelines)}
