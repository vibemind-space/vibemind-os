...
@dataclass
class AgentTaskBinderV2State:
    entries: Dict[str, dict] = field(default_factory=dict)
    _seq: int = 0
    callbacks: Dict[str, Callable] = field(default_factory=dict)

class AgentTaskBinderV2:
    PREFIX = "atbv-"
    MAX_ENTRIES = 10000

    def __init__(self) -> None:
        self._state = AgentTaskBinderV2State()
    ...
    def bind_v2(self, task_id: str, agent_id: str, scope: str = "local", metadata: Optional[dict] = None) -> str:
        ...
        self._prune()
        self._fire("bind_v2", task_id=task_id, record_id=record_id)
        return record_id
    ...
    def get_bindings(self, agent_id: str = "", limit: int = 50) -> List[dict]:
    ...
    def get_binding_count(self, agent_id: str = "") -> int:
        if not agent_id:
    ...
    def get_stats(self) -> dict:
        ...
        return {"total_bindings": len(entries), "unique_agents": len(unique)}
