...
@dataclass
class PipelineDataCorrelatorState:
    entries: Dict[str, Dict[str, Any]] = field(default_factory=dict)
    _seq: int = 0
    callbacks: Dict[str, Callable] = field(default_factory=dict)


class PipelineDataCorrelator:
    PREFIX = "pdcr-"
    MAX_ENTRIES = 10000

    def __init__(self):
        self._state = PipelineDataCorrelatorState()
    ...
    def correlate(
        ...
        entry = {
            ...
            "data_key_a": data_key_a,
            "data_key_b": data_key_b,
            "method": method,
