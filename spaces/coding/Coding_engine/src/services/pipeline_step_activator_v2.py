...
@dataclass
class PipelineStepActivatorV2State:
    entries: Dict[str, dict] = field(default_factory=dict)
    _seq: int = 0
    callbacks: Dict[str, Callable] = field(default_factory=dict)

class PipelineStepActivatorV2:
    PREFIX = "psacv-"
    MAX_ENTRIES = 10000

    def __init__(self) -> None:
        self._state = PipelineStepActivatorV2State()
    ...
    def activate_v2(self, pipeline_id: str, step_name: str, mode: str = "eager", metadata: Optional[dict] = None) -> str:
        ...
        self._prune()
        self._fire("activate_v2", pipeline_id=pipeline_id, record_id=record_id)
        return record_id
    ...
    def get_stats(self) -> dict:
        ...
        return {"total_activations": len(entries), "unique_pipelines": len(unique)}
