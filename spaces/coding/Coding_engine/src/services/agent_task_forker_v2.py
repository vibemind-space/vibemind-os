...
@dataclass
class AgentTaskForkerV2State:
    entries: Dict[str, dict] = field(default_factory=dict)
    _seq: int = 0
    callbacks: Dict[str, Callable] = field(default_factory=dict)

class AgentTaskForkerV2:
    PREFIX = "atfk-"
    MAX_ENTRIES = 10000

    def __init__(self) -> None:
        self._state = AgentTaskForkerV2State()
    ...
    def fork_v2(self, task_id: str, agent_id: str, branch: str = "default", metadata: Optional[dict] = None) -> str:
        ...
        self._prune()
        self._fire("fork_v2", task_id=task_id, record_id=record_id)
        return record_id
    ...
    def get_forks(self, agent_id: str = "", limit: int = 50) -> List[dict]:
    ...
    def get_stats(self) -> dict:
        ...
        return {"total_forks": len(entries), "unique_agents": len(agents)}
