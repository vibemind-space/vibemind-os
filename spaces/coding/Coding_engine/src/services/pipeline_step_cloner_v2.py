...
@dataclass
class PipelineStepClonerV2State:
    entries: Dict[str, dict] = field(default_factory=dict)
    _seq: int = 0
    callbacks: Dict[str, Callable] = field(default_factory=dict)

class PipelineStepClonerV2:
    PREFIX = "psclv-"
    MAX_ENTRIES = 10000

    def __init__(self) -> None:
        self._state = PipelineStepClonerV2State()
    ...
    def clone_v2(self, pipeline_id: str, step_name: str, target: str = "copy", metadata: Optional[dict] = None) -> str:
        ...
        self._prune()
        self._fire("clone_v2", pipeline_id=pipeline_id, record_id=record_id)
        return record_id
    ...
    def get_clones(self, pipeline_id: str = "", limit: int = 50) -> List[dict]:
    ...
    def get_stats(self) -> dict:
        ...
        return {"total_clones": len(entries), "unique_pipelines": len(unique)}
