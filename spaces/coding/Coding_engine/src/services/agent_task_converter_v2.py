...
@dataclass
class AgentTaskConverterV2State:
    entries: Dict[str, dict] = field(default_factory=dict)
    _seq: int = 0
    callbacks: Dict[str, Callable] = field(default_factory=dict)

class AgentTaskConverterV2:
    PREFIX = "atcvv-"
    MAX_ENTRIES = 10000

    def __init__(self) -> None:
        self._state = AgentTaskConverterV2State()
    ...
    def convert_v2(self, task_id: str, agent_id: str, target: str = "json", metadata: Optional[dict] = None) -> str:
        ...
        self._prune()
        self._fire("convert_v2", task_id=task_id, record_id=record_id)
        return record_id
    ...
    def get_conversions(self, agent_id: str = "", limit: int = 50) -> List[dict]:
    ...
    def get_conversion_count(self, agent_id: str = "") -> int:
        if not agent_id:
    ...
    def get_stats(self) -> dict:
        ...
        return {"total_conversions": len(entries), "unique_agents": len(unique)}
