...
@dataclass
class AgentTaskSchedulerV3State:
    entries: Dict[str, dict] = field(default_factory=dict)
    _seq: int = 0
    callbacks: Dict[str, Callable] = field(default_factory=dict)

class AgentTaskSchedulerV3:
    PREFIX = "ats3-"
    MAX_ENTRIES = 10000

    def __init__(self) -> None:
        self._state = AgentTaskSchedulerV3State()
    ...
    def schedule_v3(self, task_id: str, agent_id: str, priority: str = "normal", metadata: Optional[dict] = None) -> str:
        ...
        self._prune()
        self._fire("schedule_v3", task_id=task_id, record_id=record_id)
        return record_id
    ...
    def get_stats(self) -> dict:
        ...
        return {"total_schedules": len(entries), "unique_agents": len(unique)}
