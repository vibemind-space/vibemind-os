...
@dataclass
class PipelineDataCompactorV2State:
    entries: Dict[str, dict] = field(default_factory=dict)
    _seq: int = 0
    callbacks: Dict[str, Callable] = field(default_factory=dict)

class PipelineDataCompactorV2:
    PREFIX = "pdcv2-"
    MAX_ENTRIES = 10000

    def __init__(self) -> None:
        self._state = PipelineDataCompactorV2State()
    ...
    def compact_v2(self, pipeline_id: str, data_key: str, level: str = "medium", metadata: Optional[dict] = None) -> str:
        ...
        self._prune()
        self._fire("compact_v2", pipeline_id=pipeline_id, record_id=record_id)
        return record_id
    ...
    def get_stats(self) -> dict:
        ...
        return {"total_compactions": len(entries), "unique_pipelines": len(unique)}
