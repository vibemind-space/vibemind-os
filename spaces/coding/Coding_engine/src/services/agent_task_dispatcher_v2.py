...
@dataclass
class AgentTaskDispatcherV2State:
    entries: Dict[str, dict] = field(default_factory=dict)
    _seq: int = 0
    callbacks: Dict[str, Callable] = field(default_factory=dict)


class AgentTaskDispatcherV2:
    PREFIX = "atdv2-"
    MAX_ENTRIES = 10000

    def __init__(self) -> None:
        self._state = AgentTaskDispatcherV2State()
    ...
    def dispatch_v2(
        ...
        self._prune()
        self._fire("dispatch_v2", task_id=task_id, record_id=record_id)
        return record_id
