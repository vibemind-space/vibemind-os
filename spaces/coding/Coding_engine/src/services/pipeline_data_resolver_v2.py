...
@dataclass
class PipelineDataResolverV2State:
    entries: Dict[str, dict] = field(default_factory=dict)
    _seq: int = 0
    callbacks: Dict[str, Callable] = field(default_factory=dict)

class PipelineDataResolverV2:
    PREFIX = "pdrv-"
    MAX_ENTRIES = 10000

    def __init__(self) -> None:
        self._state = PipelineDataResolverV2State()
    ...
    def resolve_v2(self, pipeline_id: str, data_key: str, strategy: str = "latest", metadata: Optional[dict] = None) -> str:
        ...
        self._prune()
        self._fire("resolve_v2", pipeline_id=pipeline_id, record_id=record_id)
        return record_id
    ...
    def get_stats(self) -> dict:
        ...
        return {"total_resolutions": len(entries), "unique_pipelines": len(unique)}
