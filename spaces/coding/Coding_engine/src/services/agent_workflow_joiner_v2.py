...
@dataclass
class AgentWorkflowJoinerV2State:
    entries: Dict[str, dict] = field(default_factory=dict)
    _seq: int = 0
    callbacks: Dict[str, Callable] = field(default_factory=dict)

class AgentWorkflowJoinerV2:
    PREFIX = "awjv-"
    MAX_ENTRIES = 10000

    def __init__(self) -> None:
        self._state = AgentWorkflowJoinerV2State()
    ...
    def join_v2(self, agent_id: str, workflow_name: str, source: str = "default", metadata: Optional[dict] = None) -> str:
        ...
        self._prune()
        self._fire("join_v2", agent_id=agent_id, record_id=record_id)
        return record_id
    ...
    def get_stats(self) -> dict:
        ...
        return {"total_joins": len(entries), "unique_agents": len(unique)}
