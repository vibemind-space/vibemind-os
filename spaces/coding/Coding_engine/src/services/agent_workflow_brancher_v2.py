...
@dataclass
class AgentWorkflowBrancherV2State:
    entries: Dict[str, dict] = field(default_factory=dict)
    _seq: int = 0
    callbacks: Dict[str, Callable] = field(default_factory=dict)

class AgentWorkflowBrancherV2:
    PREFIX = "awbv-"
    MAX_ENTRIES = 10000

    def __init__(self) -> None:
        self._state = AgentWorkflowBrancherV2State()
    ...
    def branch_v2(self, agent_id: str, workflow_name: str, target: str = "main", metadata: Optional[dict] = None) -> str:
        ...
        self._prune()
        self._fire("branch_v2", agent_id=agent_id, record_id=record_id)
        return record_id
    ...
    def get_branches(self, agent_id: str = "", limit: int = 50) -> List[dict]:
    ...
    def get_stats(self) -> dict:
        ...
        return {"total_branches": len(entries), "unique_agents": len(unique)}
