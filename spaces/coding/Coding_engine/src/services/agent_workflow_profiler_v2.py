...
@dataclass
class AgentWorkflowProfilerV2State:
    entries: Dict[str, dict] = field(default_factory=dict)
    _seq: int = 0
    callbacks: Dict[str, Callable] = field(default_factory=dict)


class AgentWorkflowProfilerV2:
    PREFIX = "awpv-"
    MAX_ENTRIES = 10000

    def __init__(self) -> None:
        self._state = AgentWorkflowProfilerV2State()
    ...
    def profile_v2(
        ...
        self._prune()
        self._fire("profile_v2", agent_id=agent_id, record_id=record_id)
        return record_id
    ...
    def get_profiles(self, agent_id: str = "", limit: int = 50) -> List[dict]:
    ...
    def get_stats(self) -> dict:
        ...
        return {
            "total_profiles": len(self._state.entries),
