...
@dataclass
class AgentTaskLabelerV2State:
    entries: Dict[str, dict] = field(default_factory=dict)
    _seq: int = 0
    callbacks: Dict[str, Callable] = field(default_factory=dict)

class AgentTaskLabelerV2:
    PREFIX = "atlv2-"
    MAX_ENTRIES = 10000

    def __init__(self) -> None:
        self._state = AgentTaskLabelerV2State()
    ...
    def label_v2(self, task_id: str, agent_id: str, tag: str = "default", metadata: Optional[dict] = None) -> str:
        ...
        self._prune()
        self._fire("label_v2", task_id=task_id, record_id=record_id)
        return record_id
    ...
    def get_stats(self) -> dict:
        ...
        return {"total_labels": len(entries), "unique_agents": len(unique)}
