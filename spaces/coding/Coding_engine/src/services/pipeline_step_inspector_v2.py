...
@dataclass
class PipelineStepInspectorV2State:
    entries: Dict[str, dict] = field(default_factory=dict)
    _seq: int = 0
    callbacks: Dict[str, Callable] = field(default_factory=dict)

class PipelineStepInspectorV2:
    PREFIX = "psiv-"
    MAX_ENTRIES = 10000

    def __init__(self) -> None:
        self._state = PipelineStepInspectorV2State()
    ...
    def inspect_v2(self, pipeline_id: str, step_name: str, level: str = "basic", metadata: Optional[dict] = None) -> str:
        ...
        self._prune()
        self._fire("inspect_v2", pipeline_id=pipeline_id, record_id=record_id)
        return record_id
    ...
    def get_inspections(self, pipeline_id: str = "", limit: int = 50) -> List[dict]:
    ...
    def get_inspection_count(self, pipeline_id: str = "") -> int:
        if not pipeline_id:
    ...
    def get_stats(self) -> dict:
        ...
        return {"total_inspections": len(entries), "unique_pipelines": len(unique)}
