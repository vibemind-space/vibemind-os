...
@dataclass
class AgentWorkflowLimiterV2State:
    entries: Dict[str, dict] = field(default_factory=dict)
    _seq: int = 0
    callbacks: Dict[str, Callable] = field(default_factory=dict)

class AgentWorkflowLimiterV2:
    PREFIX = "awlv-"
    MAX_ENTRIES = 10000

    def __init__(self) -> None:
        self._state = AgentWorkflowLimiterV2State()
    ...
    def limit_v2(self, agent_id: str, workflow_name: str, max_rate: int = 100, metadata: Optional[dict] = None) -> str:
        ...
        self._prune()
        self._fire("limit_v2", agent_id=agent_id, record_id=record_id)
        return record_id
    ...
    def get_limits(self, agent_id: str = "", limit: int = 50) -> List[dict]:
    ...
    def get_stats(self) -> dict:
        ...
        return {"total_limits": len(entries), "unique_agents": len(unique)}
