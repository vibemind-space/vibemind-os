...
@dataclass
class AgentTaskMergerV2State:
    entries: Dict[str, dict] = field(default_factory=dict)
    _seq: int = 0
    callbacks: Dict[str, Callable] = field(default_factory=dict)

class AgentTaskMergerV2:
    PREFIX = "atmv-"
    MAX_ENTRIES = 10000

    def __init__(self) -> None:
        self._state = AgentTaskMergerV2State()
    ...
    def merge_v2(self, task_id: str, agent_id: str, strategy: str = "append", metadata: Optional[dict] = None) -> str:
        ...
        self._prune()
        self._fire("merge_v2", task_id=task_id, record_id=record_id)
        return record_id
    ...
    def get_merges(self, agent_id: str = "", limit: int = 50) -> List[dict]:
    ...
    def get_stats(self) -> dict:
        ...
        return {"total_merges": len(entries), "unique_agents": len(unique)}
