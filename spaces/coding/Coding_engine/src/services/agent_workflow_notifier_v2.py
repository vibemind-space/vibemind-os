...
@dataclass
class AgentWorkflowNotifierV2State:
    entries: Dict[str, dict] = field(default_factory=dict)
    _seq: int = 0
    callbacks: Dict[str, Callable] = field(default_factory=dict)

class AgentWorkflowNotifierV2:
    PREFIX = "awnv-"
    MAX_ENTRIES = 10000

    def __init__(self) -> None:
        self._state = AgentWorkflowNotifierV2State()
    ...
    def notify_v2(self, agent_id: str, workflow_name: str, channel: str = "default", metadata: Optional[dict] = None) -> str:
        ...
        self._prune()
        self._fire("notify_v2", agent_id=agent_id, record_id=record_id)
        return record_id
    ...
    def get_stats(self) -> dict:
        ...
        return {"total_notifications": len(entries), "unique_agents": len(unique)}
