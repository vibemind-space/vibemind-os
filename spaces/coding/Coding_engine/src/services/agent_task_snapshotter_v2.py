...
@dataclass
class AgentTaskSnapshotterV2State:
    entries: Dict[str, dict] = field(default_factory=dict)
    _seq: int = 0
    callbacks: Dict[str, Callable] = field(default_factory=dict)

class AgentTaskSnapshotterV2:
    PREFIX = "atsnv-"
    MAX_ENTRIES = 10000

    def __init__(self) -> None:
        self._state = AgentTaskSnapshotterV2State()
    ...
    def snapshot_v2(self, task_id: str, agent_id: str, label: str = "auto", metadata: Optional[dict] = None) -> str:
        ...
        self._prune()
        self._fire("snapshot_v2", task_id=task_id, record_id=record_id)
        return record_id
    ...
    def get_stats(self) -> dict:
        ...
        return {"total_snapshots": len(entries), "unique_agents": len(unique)}
