...
@dataclass
class AgentTaskEstimatorV3State:
    entries: Dict[str, dict] = field(default_factory=dict)
    _seq: int = 0
    callbacks: Dict[str, Callable] = field(default_factory=dict)

class AgentTaskEstimatorV3:
    PREFIX = "ate3-"
    MAX_ENTRIES = 10000

    def __init__(self) -> None:
        self._state = AgentTaskEstimatorV3State()
    ...
    def estimate_v3(self, task_id: str, agent_id: str, confidence: str = "medium", metadata: Optional[dict] = None) -> str:
        ...
        self._prune()
        self._fire("estimate_v3", task_id=task_id, record_id=record_id)
        return record_id
    ...
    def get_stats(self) -> dict:
        ...
        return {"total_estimates": len(entries), "unique_agents": len(unique)}
