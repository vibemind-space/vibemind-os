...
@dataclass
class AgentTaskAssignerV2State:
    entries: Dict[str, dict] = field(default_factory=dict)
    _seq: int = 0
    callbacks: Dict[str, Callable] = field(default_factory=dict)

class AgentTaskAssignerV2:
    PREFIX = "atasv-"
    MAX_ENTRIES = 10000

    def __init__(self) -> None:
        self._state = AgentTaskAssignerV2State()
    ...
    def assign_v2(self, task_id: str, agent_id: str, assignee: str = "auto", metadata: Optional[dict] = None) -> str:
        ...
        self._prune()
        self._fire("assign_v2", task_id=task_id, record_id=record_id)
        return record_id
    ...
    def get_stats(self) -> dict:
        ...
        return {"total_assignments": len(entries), "unique_agents": len(unique)}
