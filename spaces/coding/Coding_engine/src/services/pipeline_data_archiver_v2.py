...
@dataclass
class PipelineDataArchiverV2State:
    entries: Dict[str, dict] = field(default_factory=dict)
    _seq: int = 0
    callbacks: Dict[str, Callable] = field(default_factory=dict)

class PipelineDataArchiverV2:
    PREFIX = "pdav-"
    MAX_ENTRIES = 10000

    def __init__(self) -> None:
        self._state = PipelineDataArchiverV2State()
    ...
    def archive_v2(self, pipeline_id: str, data_key: str, retention: str = "30d", metadata: Optional[dict] = None) -> str:
        ...
        self._prune()
        self._fire("archive_v2", pipeline_id=pipeline_id, record_id=record_id)
        return record_id
    ...
    def get_archives(self, pipeline_id: str = "", limit: int = 50) -> List[dict]:
    ...
    def get_stats(self) -> dict:
        ...
        return {"total_archives": len(entries), "unique_pipelines": len(unique)}
