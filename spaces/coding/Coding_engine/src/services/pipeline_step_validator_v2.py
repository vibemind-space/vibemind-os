...
@dataclass
class PipelineStepValidatorV2State:
    entries: Dict[str, dict] = field(default_factory=dict)
    _seq: int = 0
    callbacks: Dict[str, Callable] = field(default_factory=dict)

class PipelineStepValidatorV2:
    PREFIX = "psvv-"
    MAX_ENTRIES = 10000

    def __init__(self) -> None:
        self._state = PipelineStepValidatorV2State()
    ...
    def validate_v2(self, pipeline_id: str, step_name: str, rules: str = "strict", metadata: Optional[dict] = None) -> str:
        ...
        self._prune()
        self._fire("validate_v2", pipeline_id=pipeline_id, record_id=record_id)
        return record_id
