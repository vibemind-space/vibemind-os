...
@dataclass
class PipelineDataSegmenterV2State:
    entries: Dict[str, dict] = field(default_factory=dict)
    _seq: int = 0
    callbacks: Dict[str, Callable] = field(default_factory=dict)

class PipelineDataSegmenterV2:
    PREFIX = "pdsg-"
    MAX_ENTRIES = 10000

    def __init__(self) -> None:
        self._state = PipelineDataSegmenterV2State()
    ...
    def segment_v2(self, pipeline_id: str, data_key: str, strategy: str = "equal", metadata: Optional[dict] = None) -> str:
        ...
        self._prune()
        self._fire("segment_v2", pipeline_id=pipeline_id, record_id=record_id)
        return record_id
    ...
    def get_stats(self) -> dict:
        ...
        return {"total_segments": len(entries), "unique_pipelines": len(unique)}
