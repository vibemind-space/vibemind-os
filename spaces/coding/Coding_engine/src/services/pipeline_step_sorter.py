...
@dataclass
class PipelineStepSorterState:
    entries: Dict[str, dict] = field(default_factory=dict)
    _seq: int = 0
    callbacks: Dict[str, Callable] = field(default_factory=dict)


class PipelineStepSorter:
    MAX_ENTRIES = 10000

    def __init__(self) -> None:
        self._state = PipelineStepSorterState()
    ...
    def sort(
        ...
        self._prune()
        self._fire("sort", pipeline_id=pipeline_id, record_id=record_id)
        return record_id
    ...
    def get_stats(self) -> dict:
        ...
        return {
            "total_sorts": len(self._state.entries),
