...
@dataclass
class AgentWorkflowExporterV2State:
    entries: Dict[str, dict] = field(default_factory=dict)
    _seq: int = 0
    callbacks: Dict[str, Callable] = field(default_factory=dict)

class AgentWorkflowExporterV2:
    PREFIX = "awexv-"
    MAX_ENTRIES = 10000

    def __init__(self) -> None:
        self._state = AgentWorkflowExporterV2State()
    ...
    def export_v2(self, agent_id: str, workflow_name: str, format: str = "json", metadata: Optional[dict] = None) -> str:
        ...
        self._prune()
        self._fire("export_v2", agent_id=agent_id, record_id=record_id)
        return record_id
    ...
    def get_exports(self, agent_id: str = "", limit: int = 50) -> List[dict]:
    ...
    def get_export_count(self, agent_id: str = "") -> int:
        if not agent_id:
    ...
    def get_stats(self) -> dict:
        ...
        return {"total_exports": len(entries), "unique_agents": len(unique)}
