...
@dataclass
class AgentWorkflowTrackerV2State:
    entries: Dict[str, dict] = field(default_factory=dict)
    _seq: int = 0
    callbacks: Dict[str, Callable] = field(default_factory=dict)

class AgentWorkflowTrackerV2:
    PREFIX = "awtrv-"
    MAX_ENTRIES = 10000

    def __init__(self) -> None:
        self._state = AgentWorkflowTrackerV2State()
    ...
    def track_v2(self, agent_id: str, workflow_name: str, status: str = "active", metadata: Optional[dict] = None) -> str:
        ...
        self._prune()
        self._fire("track_v2", agent_id=agent_id, record_id=record_id)
        return record_id
    ...
    def get_stats(self) -> dict:
        ...
        return {"total_trackings": len(entries), "unique_agents": len(unique)}
