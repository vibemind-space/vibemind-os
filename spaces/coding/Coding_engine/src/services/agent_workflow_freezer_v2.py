...
@dataclass
class AgentWorkflowFreezerV2State:
    entries: Dict[str, Dict[str, Any]] = field(default_factory=dict)
    _seq: int = 0
    callbacks: Dict[str, Callable] = field(default_factory=dict)


class AgentWorkflowFreezerV2:
    PREFIX = "awfz-"
    MAX_ENTRIES = 10000

    def __init__(self):
        self._state = AgentWorkflowFreezerV2State()
    ...
    def freeze_v2(
        ...
        self._prune()
        self._fire("freeze_v2", agent_id=agent_id, record_id=record_id)
        return record_id
