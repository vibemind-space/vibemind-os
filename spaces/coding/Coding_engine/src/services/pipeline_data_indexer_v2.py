...
@dataclass
class PipelineDataIndexerV2State:
    entries: Dict[str, dict] = field(default_factory=dict)
    _seq: int = 0
    callbacks: Dict[str, Callable] = field(default_factory=dict)

class PipelineDataIndexerV2:
    PREFIX = "pdiv-"
    MAX_ENTRIES = 10000

    def __init__(self) -> None:
        self._state = PipelineDataIndexerV2State()
    ...
    def index_v2(self, pipeline_id: str, data_key: str, index_type: str = "btree", metadata: Optional[dict] = None) -> str:
        ...
        self._prune()
        self._fire("index_v2", pipeline_id=pipeline_id, record_id=record_id)
        return record_id
    ...
    def get_stats(self) -> dict:
        ...
        return {"total_indexes": len(entries), "unique_pipelines": len(unique)}
