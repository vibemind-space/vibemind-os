...
@dataclass
class PipelineDataCompressorV2State:
    entries: Dict[str, dict] = field(default_factory=dict)
    _seq: int = 0
    callbacks: Dict[str, Callable] = field(default_factory=dict)

class PipelineDataCompressorV2:
    PREFIX = "pdcpv-"
    MAX_ENTRIES = 10000

    def __init__(self) -> None:
        self._state = PipelineDataCompressorV2State()
    ...
    def compress_v2(self, pipeline_id: str, data_key: str, algorithm: str = "gzip", metadata: Optional[dict] = None) -> str:
        ...
        self._prune()
        self._fire("compress_v2", pipeline_id=pipeline_id, record_id=record_id)
        return record_id
    ...
    def get_stats(self) -> dict:
        ...
        return {"total_compressions": len(entries), "unique_pipelines": len(unique)}
