...
class TestBasic:
    ...
    def test_default_param(self):
        s = AgentWorkflowProfilerV2()
        rid = s.profile_v2("v1", "v2")
        assert s.get_profile(rid)["level"] == "basic"
...
class TestList:
    ...
    def test_filter(self):
        ...
        s.profile_v2("v1", "v2")
        s.profile_v2("v3", "v4")
        assert len(s.get_profiles(agent_id="v1")) == 1
    def test_newest_first(self):
        s = AgentWorkflowProfilerV2()
        s.profile_v2("v1", "a1")
        s.profile_v2("v1", "a2")
        items = s.get_profiles(agent_id="v1")
