...
class TestBasic:
    def test_returns_id(self):
        s = PipelineDataExporterV2()
        rid = s.export_v2("v1", "v2")
        assert rid.startswith("pdxv-")
    ...
    def test_default_param(self):
        s = PipelineDataExporterV2()
        rid = s.export_v2("v1", "v2")
        assert s.get_export(rid)["format"] == "csv"
...
class TestList:
    ...
    def test_filter(self):
        ...
        s.export_v2("v1", "v2")
        s.export_v2("v3", "v4")
        assert len(s.get_exports(pipeline_id="v1")) == 1
    def test_newest_first(self):
        s = PipelineDataExporterV2()
        s.export_v2("v1", "a1")
        s.export_v2("v1", "a2")
        items = s.get_exports(pipeline_id="v1")
