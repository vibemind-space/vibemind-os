...
class TestBasic:
    def test_returns_id(self):
        s = PipelineStepValidatorV2()
        rid = s.validate_v2("v1", "v2")
        assert rid.startswith("psvv-")
...
class TestFireData:
    def test_fire_data_contains_action_key(self):
        ...
        assert captured[0]["record_id"].startswith("psvv-")
class TestReset:
