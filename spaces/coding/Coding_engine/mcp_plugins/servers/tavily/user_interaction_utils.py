# -*- coding: utf-8 -*-
"""
User interaction utilities for Tavily MCP plugin.
Simplified version for web search clarifications.
"""
import asyncio
import time
import uuid
...
def create_ask_user_tool(
    ...
    """Create the ask_user tool for Tavily agent clarifications.
        ...
        try:
            ...
            while elapsed < max_wait:
                ...
                if skip_file.exists():
                    try:
                        skip_file.unlink()
                        print(f"User skipped clarification")
                        if event_server:
    ...
    return FunctionTool(
        ask_user_impl,
        description="Ask the user a clarification question about search requirements or queries"
    )
