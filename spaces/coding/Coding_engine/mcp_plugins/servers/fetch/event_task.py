"""
Fetch UI Server for Event Streaming
"""
import asyncio
import json
import os
...
async def start_fetch_ui_server(session_id: str, event_port: int):
    """
    Start a minimal UI server for fetch event streaming
    This mirrors the pattern from Playwright/GitHub/n8n/time agents
    """
    app = web.Application()
    ...
    print(f"Fetch UI server started on http://127.0.0.1:{ui_port}", file=sys.stderr)
