"""
TaskManager UI Server for Event Streaming
"""
import asyncio
import json
import os
...
async def start_taskmanager_ui_server(session_id: str, event_port: int):
    """
    Start a minimal UI server for TaskManager event streaming
    ...
    print(f"TaskManager UI server started on http://127.0.0.1:{ui_port}", file=sys.stderr)
