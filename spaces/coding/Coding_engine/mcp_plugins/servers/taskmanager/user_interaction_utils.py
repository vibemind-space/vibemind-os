# -*- coding: utf-8 -*-
"""
User interaction utilities for TaskManager MCP plugin.
Simplified version for task management clarifications.
"""
import asyncio
import time
import uuid
...
def create_ask_user_tool(
    ...
    """Create the ask_user tool for TaskManager agent clarifications.
    ...
    return FunctionTool(
        ask_user_impl,
        description="Ask the user a clarification question about task requirements or planning"
    )
