...
try:
    import dotenv
    # Path: mcp_plugins/servers/supabase/agent.py -> go up 3 levels to project root
...
if __name__ == "__main__":
    ...
    parser.add_argument("--name", default="supabase-session", help="Agent session name")
