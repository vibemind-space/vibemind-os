"""
Time UI Server for Event Streaming
"""
import asyncio
import json
import os
...
async def start_time_ui_server(session_id: str, event_port: int):
    """
    Start a minimal UI server for time event streaming
    This mirrors the pattern from Playwright/GitHub/n8n agents
    """
    app = web.Application()
    ...
    print(f"Time UI server started on http://127.0.0.1:{ui_port}", file=sys.stderr)
