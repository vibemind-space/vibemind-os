...
try:
    ...
    def _get_model(role: str) -> str:
        _defaults = {"mirofish": "qwen2.5:32b", "mirofish_embedding": "nomic-embed-text"}
        return _defaults.get(role, "qwen2.5:32b")
...
class Config:
    ...
    LLM_MODEL_NAME = os.environ.get('LLM_MODEL_NAME', _get_model("mirofish"))
    ...
    EMBEDDING_MODEL = os.environ.get('EMBEDDING_MODEL', _get_model("mirofish_embedding"))
