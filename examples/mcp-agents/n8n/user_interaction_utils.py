# -*- coding: utf-8 -*-
"""
User interaction utilities for n8n MCP plugin.
Simplified version for workflow automation clarifications.
"""
import asyncio
import time
import uuid
...
def create_ask_user_tool(
    ...
    """Create the ask_user tool for n8n agent clarifications.
    ...
    return FunctionTool(
        ask_user_impl,
        description="Ask the user a clarification question about n8n workflow requirements"
    )
