"""
n8n UI Server for Event Streaming
"""
import asyncio
import json
import os
...
async def start_n8n_ui_server(session_id: str, event_port: int):
    """
    Start a minimal UI server for n8n event streaming
    This mirrors the pattern from Playwright/GitHub agents
    """
    app = web.Application()
    ...
    print(f"n8n UI server started on http://127.0.0.1:{ui_port}", file=sys.stderr)
