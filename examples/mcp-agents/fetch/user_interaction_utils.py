# -*- coding: utf-8 -*-
"""
User interaction utilities for Fetch MCP plugin.
Simplified version for HTTP request clarifications.
"""
import asyncio
import time
import uuid
...
def create_ask_user_tool(
    ...
    """Create the ask_user tool for fetch agent clarifications.
    ...
    return FunctionTool(
        ask_user_impl,
        description="Ask the user a clarification question about HTTP requests, URLs, or parameters"
    )
